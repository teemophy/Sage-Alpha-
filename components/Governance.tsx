    ...
    <section id="governance" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto mb-16">
          <h2 className="font-space text-4xl md:text-5xl font-bold mb-6">Governance & Protocol</h2>
          <p className="text-slate-400">
            Non-negotiable frameworks protecting the strategy, the future fund, and the integrity of the track record.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          
          <div className="glass p-8 rounded-2xl border-white/5 group hover:border-green/30 transition-all">
            <div className="w-12 h-12 bg-green/10 rounded-lg flex items-center justify-center mb-6 group-hover:green-glow transition-all">
          ...
          <div className="glass p-8 rounded-2xl border-white/5 group hover:border-gold/30 transition-all">
            <div className="w-12 h-12 bg-gold/10 rounded-lg flex items-center justify-center mb-6 group-hover:gold-glow transition-all">
