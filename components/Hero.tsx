      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center">
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full glass border border-white/5 text-white/60 text-[9px] font-bold uppercase tracking-[0.4em] mb-12">
            ...
            <h1 className="font-space text-6xl md:text-[10rem] font-bold tracking-tight mb-12 leading-[0.85] text-white">
              Systematic Logic.<br/>
              <span className="text-gold italic font-serif tracking-tight">Institutional</span> Rigor.
            </h1>
            
            <p className="text-slate-500 text-lg md:text-xl max-w-2xl mx-auto mb-16 leading-relaxed font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
              <button 
                ...
                className="group relative px-14 py-5 bg-gold text-navy font-bold rounded-xl transition-all shadow-2xl overflow-hidden text-[11px] uppercase tracking-[0.2em]"
              >
              ...
              <div className="hidden sm:flex items-center gap-6">
                ...
                <div className="text-[9px] font-mono text-slate-600 flex flex-col items-start gap-1.5 tracking-wider">
            ...
            <div className="mt-40 w-full max-w-4xl opacity-20 pointer-events-none">
              ...
              <div className="flex justify-between mt-6 text-[8px] font-mono text-slate-700 uppercase tracking-[0.5em] px-2">
