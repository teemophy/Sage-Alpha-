    ...
    <section id="identity" className="py-16 relative bg-navy">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="glass p-12 rounded-2xl border-gold/10 relative overflow-hidden flex flex-col group hover:border-gold/30 transition-all">
            ...
            <div className="text-[10px] font-mono text-gold mb-6 uppercase tracking-[0.3em] font-bold">Platform Status</div>
            <h3 className="font-space text-4xl font-bold mb-8 text-white">What We Are</h3>
            <ul className="space-y-6 text-slate-400 flex-grow text-sm md:text-base leading-relaxed">
          ...
          <div className="glass p-12 rounded-2xl border-white/5 relative overflow-hidden flex flex-col group hover:border-white/10 transition-all">
